 ...
 */
public class InsertPersonalDataVideogames extends AsyncTask<Void, Void, Boolean> {
    private final String urlString = "http://meetgame.es/MeetGame/InsertPersonalDataVideogames.php";
    private Activity activity;
    private View view;

    public InsertPersonalDataVideogames(Activity activity, View view){
    ...
    private String parseStringToJSON(){
        ...
        try {
            json
                    ...
                    .accumulate("idVideogame", this.view.getTag());
