 ...
 */
public class InsertPersonalDataPersonalData extends AsyncTask<Void, Void, Boolean> {
    private final String urlString = "http://meetgame.es/MeetGame/InsertPersonalDataPersonalData.php";
    private Activity activity;
    private View view;

    public InsertPersonalDataPersonalData(Activity activity, View view){
