 ...
 */
public class DeletePersonalDataVideogames extends AsyncTask<Void, Void, Boolean> {
    private final String urlString = "http://meetgame.es/MeetGame/DeletePersonalDataVideogames.php";
    private Activity activity;
    private View view;

    public DeletePersonalDataVideogames(Activity activity, View view){
    ...
    private String parseStringToJSON(){
        ...
        try {
            json
                    ...
                    .accumulate("idVideogame", Integer.parseInt(this.view.getTag().toString()));
